    ...
    <h1 class={`page-title ${displayClass ?? ""}`}>
      <a href={baseDir}>
        <svg width="189" height="96" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden"><defs><clipPath id="clip0"><rect x="405" y="278" width="189" height="96" /></clipPath></defs><g clip-path="url(#clip0)" transform="translate(-405 -278)">
          ...
          <text fill="var(--darkgray)" font-family="Lexend Mega,Lexend Mega_MSFontService,sans-serif" font-weight="700" font-size="303" transform="matrix(0.0980053 0 0 0.0978205 502.646 329)">M</text>
          ...
          <text fill="var(--darkgray)" font-family="Lexend Mega,Lexend Mega_MSFontService,sans-serif" font-weight="700" font-size="303" transform="matrix(0.0980053 0 0 0.0978205 502.646 364)">GEO</text>
