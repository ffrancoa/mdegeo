...
export function googleFontHref(theme: Theme) {
  ...
  return `https://fonts.googleapis.com/css2?family=Lexend+Mega&family=${code}&family=${header}:wght@400;700&family=${body}:ital,wght@0,400;0,600;1,400;1,600&display=block`
}
